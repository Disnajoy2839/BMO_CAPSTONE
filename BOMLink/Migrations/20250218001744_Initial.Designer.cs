...
namespace BOMLink.Migrations
{
    ...
    [Migration("20250218001744_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BOMLink.Models.DraftBOMItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BOMLink.Models.RFQ", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = 0,
                            SupplierId = 1,
                            UpdatedAt = new DateTime(2024, 2, 15, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            UserId = "2"
                        },
                        new
                        {
                            ...
                            SentDate = new DateTime(2024, 2, 15, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = 1,
                            SupplierId = 2,
                            UpdatedAt = new DateTime(2024, 2, 15, 10, 0, 0, 0, DateTimeKind.Unspecified),
                            UserId = "1"
            ...
            modelBuilder.Entity("BOMLink.Models.Supplier", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ContactEmail = "sathler@ymail.com",
                            CreatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Graybar",
                            SupplierCode = "GRAELE",
                            UpdatedAt = new DateTime(2021, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
            ...
            modelBuilder.Entity("BOMLink.Models.RFQItem", b =>
                {
                    b.HasOne("BOMLink.Models.BOMItem", "BOMItem")
                        .WithMany()
